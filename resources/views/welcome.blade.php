...
<div class="container-fluid example-classname" id="2">
    <div class="row">
        ...
        <div class="col-lg-5 col-md-11 pl-md-5 pl-3 pt-lg-5 mt-lg-5 pt-5 mt-5">
            ...
            <h3 class="TTBold text-black pt-2" style="font-size: 2em; line-height: 1.2em; text-transform: uppercase;" data-aos="flip-down">Нет никого, кто любил бы боль саму по себе, кто искал бы ее</h3>
