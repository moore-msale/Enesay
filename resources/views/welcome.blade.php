...
<div class="container-fluid align-items-center pt-5 example-classname" id="1" style="background-image: url({{ asset('images/bg1.png') }});">
    <div class="row align-items-center pt-md-5 pt-0 mt-5 pl-md-5 pl-2">
        <div class="col-lg-8 pt-lg-0 pt-md-5 pt-0 mt-lg-0 mt-md-5 mt-0">
            <div class="row">
                <div class="col-11 text-right pt-lg-0 pt-5 d-md-none d-block">
                    <a href="">
                ...
                <div class="col-lg-3">
                    <div class="row align-items-center justify-content-start flex-nowrap">
                        <div class="col-lg-5 col-md-2 col-3 pr-0 pr-lg-2 mt-lg-0 mt-md-5"><h1 style="font-family: RobotoBold; font-size: 3.1em; line-height: 1.3em;text-transform: uppercase;color: #FFFFFF;">01</h1></div>
        ...
        <div class="d-lg-block d-none" id="pick" style="transform: rotate(90deg);position: absolute;top: 55%;right: -10.2%;">
...
<div class="container-fluid example-classname" id="2">
    <div class="row">
        ...
        <div class="col-lg-5 col-md-11 pl-md-5 pl-3 pt-lg-5 mt-lg-5 pt-5 mt-5">
            ...
            <div class="row pt-5 mt-lg-0 mt-md-5 mb-lg-0 mb-md-5 mb-5">
                <div class="col-lg-6 col-md-6 text-center">
                    ...
                    <img class="img-fluid mt-4 w-25 pt-lg-0 pt-md-5" src="{{asset('images/parking.png')}}" alt="">
                ...
                <div class="col-lg-6 col-md-6 text-center ">
                    ...
                    <img class="img-fluid mt-4 w-25 pt-lg-0 pt-md-5" src="{{asset('images/amphitheatre.png')}}" alt="">
...
<div class="container-fluid pl-lg-5 pl-md-5 px-md-5 pt-4 pb-lg-5 example-classname" id="gallery">
    <div class="row mt-lg-5 pt-lg-5">
        ...
        <div class="col-lg-7 col-12 d-lg-block d-md-none d-none">
            <div class="carousel">
...
<div class="container-fluid pt-lg-5 pt-4 pb-lg-5 pb-4 example-classname" id="4" style="background-image:url({{ asset('images/bg4.png') }}); background-size: cover;">
    <h3 class="TTBold text-white pt-2 text-lg-center text-md-left pb-lg-5 pb-4 pt-lg-5 pt-md-5 pl-lg-0 pl-md-5 pl-3" style="font-size: 2em; line-height: 1.2em; text-transform: uppercase;">Генеральный план</h3>
    <div class="row">
        <div class="col-2"></div>
    ...
    <div class="mt-lg-5 pl-lg-3 pr-lg-3 point d-lg-block d-md-none">
        <div class="row pl-lg-0 pl-4">
            <div class="col-lg-2 col-12 d-flex 10 pt-3">
        ...
        <div class="col-lg-2 col-12 d-flex 11 pt-3">
        ...
        <div class="col-lg-2 col-12 d-flex 12 pt-3">
        ...
        <div class="col-lg-2 col-12 d-flex 13 pt-3">
        ...
        <div class="col-lg-2 col-12 d-flex 14 pt-3">
        ...
        <div class="col-lg-2 col-12 d-flex 15 pt-3">
    ...
    <div class="mt-lg-5 pt-lg-5 pt-md-5 pl-lg-0 pl-md-5 point d-lg-none d-md-block d-none pb-lg-0 pb-md-5">
        ...
        <div class="col-4">
            <div class="row">
                <div class="col-12 d-flex 10 pt-3">
                ...
                <div class="col-12 d-flex 11 pt-3">
                ...
                <div class="col-12 d-flex 12 pt-3">
...
<div class="container-fluid example-classname p-lg-5 p-5" id="5" style="background-image: url({{ asset('images/bg5.png') }}); background-size: cover; background-position: center;">
    <div class="row align-items-end">
        <div class="col-lg-6 col-md-10 pr-lg-5">
            <h3 class="TTBold text-black pt-2 pb-lg-4 pt-lg-5 text-first" style="font-size: 1.7em; line-height: 1.2em; text-transform: uppercase;">Будьте счастливым обладателем собственности в люксовом поселке Эне-Сай</h3>
            <div class="col-lg-9 pt-lg-0 pt-md-5 px-0">
                <p class="TTLight text-black pb-3" style="font-size: 17px; line-height: 25px;">Оставьте заявку на обратный звонок и мы ответим на все ваши вопросы </p>
                <form>
        ...
        <div class="col-lg-6 pt-lg-0 pt-md-5 pt-4">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-4 col-6">
                    <h4 class="TTRegular text-black text-center pb-md-0 pb-4">Продано</h4>
                    <div class="line"></div>
                    <div class="numbers"><div class="number-item text-center pt-md-0 pt-4"><span class="value">31</span></div></div>
                </div>
                <div class="col-lg-4 col-md-4 col-6">
                    <h4 class="TTRegular text-black text-center pb-md-0 pb-4">Резерв</h4>
                    <div class="line"></div>
                ...
                <div class="col-lg-4 col-md-4 col-6 pt-lg-0 pt-md-0 pt-5">
                    <h4 class="TTRegular text-black text-center pb-md-0 pb-4">Свободно</h4>
                    <div class="line"></div>
    ...
    <div class="row pr-lg-5 pl-lg-5 mt-lg-5 pt-lg-5 pt-md-5 pt-5 text-md-left text-center">
        <div class="col-lg-2 col-md-5 pt-lg-0 pt-md-5 pt-4">
...
<div class="container-fluid pt-lg-5 pb-lg-3 example-classname pb-md-5" id="6">
    <div class="row pt-lg-5">
        ...
        <div class="col-lg-5 p-0 transformblock d-lg-block d-md-none d-block">
            <h3 class="TTExtraBold text-black pt-lg-2 pt-5 pl-lg-0 pl-4 text-first " style="font-size: 2.9em; line-height: 1.2em; text-transform: uppercase;">Последние новости</h3>
            ...
            <div class="row pt-4 pl-lg-5">
                ...
                <div class="col-lg-8 col-11 p-0">
                    ...
                    <button class="btn btn-pictures ml-lg-0 ml-4"><a href="/news">Читать все новости</a></button>
                </div>
            </div>
            </div>
        </div>
    ...
    <div class="row m-4 pt-lg-5 pb-lg-5">
       <div class="col-lg-2 col-md-5 pt-lg-0 pt-md-5 pt-4">
        ...
        <div class="col-lg-2 col-md-5 pt-lg-0 pt-md-5 pt-4 pl-lg-3 pl-md-5">
            <h3 class="robotobold mb-0" style="color: #C6972A; font-size: 1em;line-height: 31px;">02</h3>
            <h5 class="TTBold text-black mb-0" style="font-size: 1em;line-height: 20px; text-transform: uppercase;">Заголовок <br>новости</h5>
            <p class="TTRegular text-black pt-2" style="font-size: 13px;line-height: 17px;">Давно выяснено, что при оценке дизайна и композиции читаемый текст мешает сосредоточиться. Lorem Ipsum используют потому, что тот обеспечивает более или менее стандартное заполнение</p>
            <a href="/news_page" style="text-decoration: none;">
