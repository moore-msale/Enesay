        ...
        <div class="col-lg-5 col-md-11 pl-md-5 pl-3 pt-lg-5 mt-lg-5 pt-5 mt-5">
            ...
            <div class="row pt-md-5 pt-3 mt-lg-0 mt-md-5 mt-2 mb-lg-0 mb-md-5 mb-5">
                <div class="col-lg-6 col-md-6 text-center" >
                    ...
                    <img class="img-fluid mt-lg-2 mt-md-4 mt-0 w-25 pt-lg-0 pt-md-5" data-aos="flip-up" src="{{asset('images/parking.png')}}" alt="">
                ...
                <div class="col-lg-6 col-md-6 text-center ">
                    ...
                    <img class="img-fluid mt-lg-2 mt-md-4 mt-0 w-25 pt-lg-0 pt-md-5 pt-4" data-aos="flip-up" src="{{asset('images/amphitheatre.png')}}" alt="">
