...
@section('content')
    ...
    <img class="w-100 d-lg-block d-none" style="position: absolute; z-index: -1;" src="{{ asset('images/about_us.png') }}" alt="">
    ...
    <div class="container" style="padding-top:18%;">
        <div class="row justify-content-center">
            <h1 class="TTLight text-center text-main" style="font-size: 300%; line-height: 140%; text-transform: uppercase; color: white;">
                <p class="TTBold">Современный жилой комплекс</p>
            ...
            <img class="w-75" style="transform: translateY(-7%)" src="{{ asset('images/about_us_1.png') }}" alt="">
